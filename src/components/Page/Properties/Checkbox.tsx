...
// Transform the checkbox into a REACT HOOK FORM
export const Checkbox = ({ value }) => (
    <div
        className={clsx(
            'w-max gap-1 grid place-items-center relative cursor-pointer group',
            {
                'text-gray-100': value,
                'text-transparent hover:text-light-400 dark:hover:text-dark-700':
                    !value,
            }
        )}
    >
