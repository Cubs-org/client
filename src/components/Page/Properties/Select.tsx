...
const Selected = ({ value, color }) => {
    return (
        <div
            className={clsx(
                'w-max text-sm font-bold px-3 py-0.5 rounded-md text-dark-700 dark:text-light-300 cursor-pointer transition-all ease-in',
                {
                    ...
                    <ul className="min-w-[200px] flex flex-col gap-1.5 p-1">
                        ...
                        {items.map((item, index) => (
                            <li
                                key={index}
                                className={clsx(
                                    'w-fit text-xs font-semibold px-3 py-1 rounded-md text-light-300 cursor-pointer transition-all ease-in-out',
                                    {
