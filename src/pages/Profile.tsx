        ...
        <div className="w-full h-full flex flex-col">
            ...
            <div className="w-full md:w-4/5 md:m-auto flex flex-col-reverse flex-grow gap-3 items-center md:flex-row">
                <div className="flex flex-col flex-grow items-center md:items-start w-4/5 md:w-full m-auto">
                    <h3 className="text-base md:text-lg font-bold text-dark-400 bg-transparent dark:text-light-700">
                        {user?.data?.email || 'minion'}
                    </h3>
                    <input
                    ...
                    <span className="text-sm sm:text-base text-dark-300 font-medium dark:text-light-800">
                        Criado em{' '}
                        {formatDate(
                            (
                                (user?.data?.createdAt as string) || 'minion'
                            ).substring(0, 10)
                        )}
                    </span>
                </div>
                ...
                <div className="w-1/2 static md:relative group py-3 md:py-2">
                    ...
                    <div className="float-right -mt-[60px]">
                        ...
                        >
                            <span className="flex items-center justify-center bg-violet-500 text-xl md:text-3xl group-hover:scale-100 scale-0 min-w-[60px] min-h-[60px] md:w-[80px] md:h-[80px] rounded-full shadow-full transition-all">
                                <FaImage />
                            </span>
                        </Popover>
                    </div>
